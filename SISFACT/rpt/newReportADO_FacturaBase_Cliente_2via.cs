namespace SISFACT.rpt
{
    ...
    public class newReportADO_FacturaBase_Cliente_2via : ReportClass
    {
        public override string FullResourceName
        {
            get
            {
                return "SISFACT.rpt.newReportADO_FacturaBase_Cliente_2via.rpt";
            }
            set
            {
            }
        ...
        public override string ResourceName
        {
            get
            {
                return "newReportADO_FacturaBase_Cliente_2via.rpt";
            }
            set
            {
            }

namespace SISFACT
{
    ...
    public class FrmPesquisa : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (nhc.Length > 0)
            {
                this.carregaGrid(this._Utentes.GetNHC(nhc, num));
            }
            else
            {
                this.carregaGrid(this._Utentes.GetNome(nome, num));
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            this.textBox1.Clear();
            this.textBox4.Clear();
            this.carregaGrid(this._Utentes.Utentes);
        }
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                string nhc = row["NHC"].ToString();
                string nome = row["Nome"].ToString();
                int num = int.Parse(row["paciente_id"].ToString());
                UtentesEventArgs args = new UtentesEventArgs(nhc, nome, num);
                this.UtenteSelecionado(this, args);
                base.Close();
            }
        }
        ...
        private void GridFormat()
        {
            ...
            this.dataGridView1.Columns[1].HeaderText = "NHC";
        ...
        {
            ComponentResourceManager manager = new ComponentResourceManager(typeof(FrmPesquisa));
            ...
            this.textBox4.Location = new Point(0x36, 0x13);
            ...
            this.textBox1.Location = new Point(0x36, 0x39);
            ...
            base.Name = "FrmPesquisa";
            base.StartPosition = FormStartPosition.CenterParent;
            this.Text = "Pesquisa -  Utentes";
            base.Load += new EventHandler(this.FrmPesquisa_Load);
